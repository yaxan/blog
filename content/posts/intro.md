...
lazy and will probably vibecode those to an extent, but I'll be sure to 
at least run through them myself.
...
sources are missing. Some of my notes suck too so LLMs will definitely be put to work on cleaning up and formatting stuff.
